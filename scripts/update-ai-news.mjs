...
const categories = [
  ...
  },
  {
    id: 'openai',
    label: 'OpenAI公式',
    description: 'OpenAI News と OpenAI 日本語ニュース。'
  },
  {
    id: 'anthropic',
    label: 'Anthropic公式',
    description: 'Anthropic / Claude の公式・準公式ニュース。'
  },
  {
    id: 'google',
    label: 'Google公式',
    description: 'Google AI、Gemini、Google Japan Blog のAI関連情報。'
  },
  {
    id: 'copilot',
    label: 'Copilot公式',
    description: 'GitHub Copilot と Microsoft Copilot 関連ニュース。'
  }
];
